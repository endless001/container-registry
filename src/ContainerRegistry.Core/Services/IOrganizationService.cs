...
public interface IOrganizationService
{
    ...
    Task<PagedList<OrganizationResponse>> GetAsync(int pageSize, int pageIndex);
    ...
    Task<List<MemberResponse>> GetMemberAsync(string @namespace, CancellationToken cancellationToken);
}